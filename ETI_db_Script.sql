...
CREATE TABLE Driver
(Username varchar(10),
FirstName varchar(20), LastName varchar(20), PhoneNo INT, Email varchar(100), Password varchar(20), IDNo varchar(9), LicenseNo varchar(10), IsBusy char(1) DEFAULT NULL,
PRIMARY KEY (Username));
...
("jonn123", "george7", "334059", "455098", "2020-12-18 12:52:40", "1");
INSERT INTO CarTrip (PassengerUsername, DriverUsername, Pickup, Dropoff, PickupTime, IsCompleted) VALUES
("jonn123", "mikey33", "102333", "859444", "2021-12-18 12:52:40", "1");
INSERT INTO CarTrip (PassengerUsername, DriverUsername, Pickup, Dropoff, PickupTime, IsCompleted) VALUES
("timho1", "mikey33", "102553", "859404", "2022-12-18 12:52:40", "1");
INSERT INTO CarTrip (PassengerUsername, DriverUsername, Pickup, Dropoff, PickupTime, IsCompleted) VALUES
("jonn123", "george7", "107763", "733444", "2021-10-20 12:52:40", "1");
...
INSERT INTO Driver (Username, FirstName, LastName, PhoneNo, Email, Password, IDNo, LicenseNo, IsBusy) VALUES
("george7", "George", "Johnson", 90097007, "george@gmail.com", "password", "T0122355K",  "SEA1234G", "0");
INSERT INTO Driver (Username, FirstName, LastName, PhoneNo, Email, Password, IDNo, LicenseNo, IsBusy) VALUES
("mikey33", "Mike", "Miller", 78900789, "mike@gmail.com", "qwerty", "T0990555J",  "SBC1005F", "0");
